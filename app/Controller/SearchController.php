...
class SearchController extends BaseController
{
     ...
     * @param boolean $getCount True to return number of results
     * @return array[]|int matches in offer table
     */
    public static function getOffers($offset = 0, $like = "", $sex = "", $age = array(0, 20), $size = array(0, 20),
                                     $weight = array(0, 3000), $getCount = false) {
        ...
        try {
            ...
            $model = OfferModel::getSearchResultsFromDatabase($getCount, $offerDao, $keyedSearchValuesArray);
