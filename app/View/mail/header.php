...
<head>
    ...
    <meta name="description" content="Vorschau für Mails">
    ...
    <link
            ...
            ?>">
    <link rel="stylesheet" href="<?= CacheBuster::serve('css/shared/page.css') ?>">
    <link rel="stylesheet" href="<?= CacheBuster::serve('css/mail-preview.css') ?>">
</head>