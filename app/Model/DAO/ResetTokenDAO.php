...
class ResetTokenDAO implements ResetTokenDAOInterface
{
    ...
    public function create($obj)
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('ResetTokenDAO create error ' . implode(",", $stmt->errorInfo()));
        }
    }
    ...
    public function read($token)
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('ResetTokenDAO read error ' . implode(",", $stmt->errorInfo()));
        }
    }
    ...
    public function update($obj)
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('ResetTokenDAO update error ' . implode(",", $stmt->errorInfo()));
        }
    }
    ...
    public function deleteExpired() {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('ResetTokenDAO deleteExpired error ' . implode(",", $stmt->errorInfo()));
        }
    }
    ...
    public function deleteForUser($id) {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('ResetTokenDAO deleteForUser error ' . implode(",", $stmt->errorInfo()));
        }
    }
}