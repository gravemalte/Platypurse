...
class UserReportDAO implements ReportDAOInterface
{
    ...
    public function create($obj)
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('UserReportDAO create error ' . implode(",", $stmt->errorInfo()));
        }
    }
    ...
    public function read($id)
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('UserReportDAO read error ' . implode(",", $stmt->errorInfo()));
        }
    }
    ...
    public function readAll()
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('UserReportDAO readAll error ' . implode(",", $stmt->errorInfo()));
        }
    }
    ...
    public function update($obj)
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('UserReportDAO update error ' . implode(",", $stmt->errorInfo()));
        }
    }
}