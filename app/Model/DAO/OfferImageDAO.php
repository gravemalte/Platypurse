...
class OfferImageDAO implements OfferImagesDAOInterface
{
    ...
    public function create($obj)
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('OfferImageDAO create error ' . implode(",", $stmt->errorInfo()));
        }
    ...
    public function readByOfferId($offerId)
    {
        ...
        if($stmt->execute()){
            ...
            throw new PDOException('OfferImageDAO select by offerId error ' . implode(",", $stmt->errorInfo()));
        }
    }
    ...
    public function update($obj)
    {
        ...
        if($stmt->execute()) {
            ...
            throw new PDOException('OfferImageDAO update error ' . implode(",", $stmt->errorInfo()));
        }
    }
}